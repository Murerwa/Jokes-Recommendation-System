...
print ".glory5{filter: glow(color:#ffffff, strength=5); color:white; font-weight:900; text-shadow: 1px 1px 45px #ffffff;}"
print ".glory6{filter: glow(color:#ffffff, strength=6); color:white; font-weight:900; text-shadow: 1px 1px 55px #ffffff;}"
print ".glory7{filter: glow(color:#ffffff, strength=7); color:white; font-weight:900; text-shadow: 1px 1px 65px #ffffff;}"
print ".glory8{filter: glow(color:#ffffff, strength=8); color:white; font-weight:900; text-shadow: 1px 1px 75px #ffffff;}"
print ".glory9{filter: glow(color:#ffffff, strength=9); color:white; font-weight:900; text-shadow: 1px 1px 85px #ffffff;}"
print "</style>"
