...
print ".glory2{filter: glow(color:#ffffff, strength=2); color:white; font-weight:900; text-shadow: 1.3px 1.3px 6.5px #ffffff;}"
print ".glory3{filter: glow(color:#ffffff, strength=3); color:white; font-weight:900; text-shadow: 1.6px 1.6px 8px #ffffff;}"
print ".glory4{filter: glow(color:#ffffff, strength=4); color:white; font-weight:900; text-shadow: 2px 2px 10px #ffffff;}"
print ".glory5{filter: glow(color:#ffffff, strength=5); color:white; font-weight:900; text-shadow: 2.3px 2.3px 11.5px #ffffff;}"
print ".glory6{filter: glow(color:#ffffff, strength=6); color:white; font-weight:900; text-shadow: 2.6px 2.6px 13px #ffffff;}"
print ".glory7{filter: glow(color:#ffffff, strength=7); color:white; font-weight:900; text-shadow: 3px 3px 15px #ffffff;}"
print ".glory8{filter: glow(color:#ffffff, strength=8); color:white; font-weight:900; text-shadow: 3.3px 3.3px 16.5px #ffffff;}"
print ".glory9{filter: glow(color:#ffffff, strength=9); color:white; font-weight:900; text-shadow: 3.6px 3.6px 18px #ffffff;}"
print "</style>"
