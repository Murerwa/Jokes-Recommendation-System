...
print ".glory2{filter: glow(color:#ffffff, strength=2); color:white; font-weight:900; text-shadow: 1px 1px 15px #ffffff;}"
print ".glory3{filter: glow(color:#ffffff, strength=3); color:white; font-weight:900; text-shadow: 1px 1px 25px #ffffff;}"
print ".glory4{filter: glow(color:#ffffff, strength=4); color:white; font-weight:900; text-shadow: 1px 1px 35px #ffffff;}"
print ".glory5{filter: glow(color:#ffffff, strength=5); color:white; font-weight:900; text-shadow: 1px 1px 45px #ffffff, 1px 1px 5px #ffffff;}"
print ".glory6{filter: glow(color:#ffffff, strength=6); color:white; font-weight:900; text-shadow: 1px 1px 55px #ffffff, 1px 1px 5px #ffffff;}"
print ".glory7{filter: glow(color:#ffffff, strength=7); color:white; font-weight:900; text-shadow: 1px 1px 65px #ffffff, 1px 1px 5px #ffffff, 1px 1px 10px #ffffff;}"
print ".glory8{filter: glow(color:#ffffff, strength=8); color:white; font-weight:900; text-shadow: 1px 1px 75px #ffffff, 1px 1px 5px #ffffff, 1px 1px 10px #ffffff;}"
print ".glory9{filter: glow(color:#ffffff, strength=9); color:white; font-weight:900; text-shadow: 1px 1px 85px #ffffff, 1px 1px 5px #ffffff, 1px 1px 10px #ffffff, 1px 1px 15px #ffffff;}"
print "</style>"
